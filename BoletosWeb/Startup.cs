...
namespace BoletosWeb
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<BoletosWebContext>(options => options.UseSqlServer(Configuration.GetConnectionString("BoletosWebContext")));
            ...
            services.AddScoped<GaragemService>();
